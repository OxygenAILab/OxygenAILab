...
const sections: Array<{ title: { zh: string; en: string }; copy: { zh: string; en: string } }> = [
  ...
  },
  {
    ...
    copy: {
      zh: `如需了解数据使用边界、申请删除或纠正内容，请写信到 ${siteConfig.contactEmail}。我们会在确认身份后按最小必要范围处理。`,
      en: `For data-boundary questions, deletion, or correction requests, email ${siteConfig.contactEmail}. We process requests with the minimum scope needed after confirming identity.`,
    },
  },
];
